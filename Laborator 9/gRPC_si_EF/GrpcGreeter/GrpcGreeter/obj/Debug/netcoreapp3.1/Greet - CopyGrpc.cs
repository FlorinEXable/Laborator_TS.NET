...
namespace GrpcGreeter {
  ...
  public static partial class Greeter
  {
    ...
    {
      get { return global::GrpcGreeter.GreetCopyReflection.Descriptor.Services[0]; }
    }
    ...
    public abstract partial class GreeterBase
    {
      ...
      /// <param name="context">The context of the server-side call handler being invoked.</param>
      /// <returns>The response to send back to the client (wrapped by a task).</returns>
      public virtual global::System.Threading.Tasks.Task<global::GrpcGreeter.HelloReply> SayHelloAgain(global::GrpcGreeter.HelloRequest request, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, GreeterBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_SayHelloAgain, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::GrpcGreeter.HelloRequest, global::GrpcGreeter.HelloReply>(serviceImpl.SayHelloAgain));
    }
