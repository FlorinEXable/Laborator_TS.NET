...
namespace EFStudiiDeCazLab
{
    class Program
    {
        static void TestSelfReferencing()
        {
            ...
            {
                var person = new SelfReference
                {
                    Name = "Ionescu Ion"
                };
                context.SelfReferences.Add(person);
                var person2 = new SelfReference
                {
                    Name = "Ionescu Ioana",
                    ParentSelfReference = person
                };
                context.SelfReferences.Add(person2);
                var person3 = new SelfReference
                {
                    Name = "Ionescu Ionut",
                    ParentSelfReference = person,

                };
                context.SelfReferences.Add(person3);
            ...
            using (var context = new ModelSelfRefrences())
            {
                ...
                {
                    Console.WriteLine("Id-ul parintelui : {0}  Nume: {1}", p.ParentSelfReferenceId, p.Name);
                    foreach (var copil in p.References)
                    {
                        Console.WriteLine("Copil {0}", copil.Name);
                    }
                }
            }
        }
